...
namespace Play.ViewModels
{
    ...
    public class PlayViewModel : ReactiveObject, IPlayViewModel
    {
        ...
        public PlayViewModel(IScreen screen, ILoginMethods loginMethods)
        {
            ...
            _CurrentSong = Observable.Never<Song>().ToProperty(this, x => x.CurrentSong);
            _Queue = Observable.Never<IEnumerable<Song>>().ToProperty(this, x => x.Queue);
            _AllSongs = Observable.Never<IEnumerable<SongTileViewModel>>().ToProperty(this, x => x.AllSongs);
            ...
            this.WhenNavigatedTo(() => {
                ...
                _ListenUrl = Observable.Defer(playApi.ListenUrl)
                ...
                _Queue = shouldUpdate.SelectMany(_ => playApi.Queue())
                ...
                _AllSongs = this.WhenAny(x => x.CurrentSong, x => x.Queue, 
                    ...
                    .ToProperty(this, x => x.AllSongs, Enumerable.Empty<SongTileViewModel>());
